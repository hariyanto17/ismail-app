...
import { useGetDailyAnalyticsQuery } from '../redux/apiSlice';
...
export const DailyAnalyticsScreen = () => {
  ...
  const { data: response, isLoading } = useGetDailyAnalyticsQuery(dateStr);
  ...
  const { summary, topProducts, lowProducts, hourlySales } = analyticsData;
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        {isLoading ? (
          <View style={styles.loadingBox}>
            ...
            <Text style={styles.loadingText}>Memuat Analisis Harian...</Text>
          </View>
        ) : (
          <View style={styles.dashboardContainer}>
            ...
            <View style={styles.sectionCard}>
              <Text style={styles.sectionTitle}>Jam Sibuk Bisnis</Text>
...
export default DailyAnalyticsScreen;
